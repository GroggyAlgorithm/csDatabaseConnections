...
public abstract class DatabaseConnector
{
	...
	protected HashSet<DataRow> ExecSql(string cmd, string connectionString, CommandType cmdType = CommandType.Text)
	{
		//The return hash set
	...
	protected List<DataRow> ExampleExecSqlStoredProc(string stored_proc_name, int id, string connectionString, string idDbName)
	{
